...
{
    const char* pszTimestamp = "Xchange to change the otc game";
    const CScript genesisOutputScript = CScript() << ParseHex("047ff1e22366caa72c74210ff6fd718e71b5a4c509588ccb53d92bc53c89c6c8fc89a848548ab3b155da8f2a5121db1e891e44cc062a51e8410b84863e598d8b6e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.XCGZawyLWMAHeight = 120;
        ...
        vSeeds.push_back(CDNSSeedData("51.75.65.15", "51.75.65.15"));
        vSeeds.push_back(CDNSSeedData("66.42.84.31", "66.42.84.31"));
        vSeeds.push_back(CDNSSeedData("116.203.135.147", "116.203.135.147"));
        vSeeds.push_back(CDNSSeedData("159.69.208.25", "159.69.208.25"));
        vSeeds.push_back(CDNSSeedData("95.217.97.220", "95.217.97.220"));
        vSeeds.push_back(CDNSSeedData("128.199.37.166", "128.199.37.166"));
        vSeeds.push_back(CDNSSeedData("207.148.4.100", "207.148.4.100"));
        vSeeds.push_back(CDNSSeedData("207.180.251.113", "207.180.251.113"));
        ...
        // Xchange BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Xchange BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Xchange BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkPubKey = "04ac0d9aa9e6de9275de67093b31c640917547d95713f2a121d7806c5d7b95411d8478f02e4c4fc51b78ec579468ae37a2c15207adfcaec44fa3414a8e420b70a4";
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("04d097380e86e145eb1267aad57a1214aeaacc85a52d20a6564c4da10a3f7b768949e51445060fe04af80ddfe3d1decb07fa9df9b5f5805eb481e047dc5d684e00");
        ...
        // Testnet Xchange script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Xchange BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Xchange BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Xchange BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        // Regtest Xchange addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Xchange script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Xchange BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Xchange BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Xchange BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
